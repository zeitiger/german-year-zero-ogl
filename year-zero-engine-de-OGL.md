...
Die Year Zero Engine wurde ursprünglich für *Mutant: Jahr Null* entwickelt, wurde aber weiter modifiziert und an eine breite Palette von Spielen mit unterschiedlichen Themen und Settings angepasst. Dennoch bleiben sechs Kernfunktionen des Spiels in allen Iterationen gleich. Diese werden im Folgenden aufgeführt und erläutert.
...
**Anfangswerte:** Wenn du deinen Spielcharakter erstellst, kannst du eine Anzahl von Punkten auf die Attribute verteilen. Wie viele Punkte das sind, wird durch das Alter bestimmt - siehe die Tabelle unten. Du kannst jedem Attribut nicht weniger als 2 und nicht mehr als 5 Punkte zuweisen.
...
Es können eine Anzahl von regulären Gegenständen tragen werden, die dem Doppelten der Stärke entspricht. Verwenden dabei den Basiswert für Stärke, nicht den temporären Wert, der durch erlittenen [Schaden](#8q8i5b7qicim) <!-- TODO ToC --> reduziert wird.
...
Man kann vorübergehend mehr als die normale Tragelast (Stärke x 2 Gegenstände) tragen. In diesem Fall musst du einen Wurf für die Fertigkeit "Ausdauer" <!-- TODO Glossar --> machen, wann immer du in einer Kampfrunde rennen oder eine größere Strecke gehen willst. Wenn der Wurf fehlschlägt, musst du entweder das, was du trägst, fallen lassen, bleiben wo du bist, oder einen Punkt [Schaden](#8q8i5b7qicim) auf Geschicklichkeit <!-- TODO Glossar --> erleiden und weitergehen.
...
Schließlich gibst du deinen SC einen Namen. Die Archetypen schlagen in der Regel geeignete Namen vor, aber du kannst dich auch einen eigenen Namen ausdenken, wenn du dies bevorzugen.
...
## **DIE 12 KERNFERTIGKEITEN** <!-- TODO Glossar -->
...
> ### ***ANGEPASSTE WÜRFEL***
> 
> *Bei einigen Year Zero Engine-Spielen sind Sets mit benutzerdefinierten Würfeln erhältlich. Diese haben oft spezielle Symbole auf der Eins- und Sechsseite, um das Erkennen von Erfolgen und Unheil zu erleichtern.* <!-- TODO Glossar -->
...
Du kannst Modifikationen auf verschiedene Arten erhalten: durch Talente, durch die Schwierigkeit der Aktion selbst und durch die Hilfe von anderen.
...
Wenn deine körperliche Ausdauer oder dein Durchhaltevermögen getestet wird, würfelst du auf "Ausdauer". Würfelst du zum Beispiel für diese Fertigkeit, wenn du bei extremem Wetter reist oder wenn du gezwungen bist, bittere [Kälte](#lh6jzaxghmf9) <!-- TODO Glossar --> zu ertragen.
...
**Waffen**: Im Nahkampf kannst du [Nahkampfwaffen](#y1zvug9299at) verwenden.
...
**Stunts**: Für jeden zusätzlichen Erfolg, den du würfelst, erfährst du die Antwort auf eine der folgenden Fragen:
...
Als Charakter in einem Year Zero Engine-Spiel besteht ein erhebliches Risiko, dass du und deine Freunde früher oder später verletzt werden. In diesem Fall ist die Fertigkeit "Heilen" nützlich. Sie kann auf zwei verschiedene Arten eingesetzt werden:
...
Du kannst beim [Initiative ziehen](#n0khjzseshkn) zwei Initiative-Karten statt einer ziehen. Wählen diejenige, die du verwenden möchtest, und mischen die andere zurück in den Stapel, bevor andere ihre Karten ziehen.
...
Kämpfe sind in den meisten Year Zero Engine-Spielen tödlich. Bevor du einen Kampf beginnst, solltest du dich immer fragen: Ist es das wert?
...
**Nahkampf**: Wenn du einen aktiven Gegner auf Armeslänge Reichweite hast, kannst du nicht einfach von ihm weggehen. Stattdessen musst du dich [zurückziehen](#kj6k2bo0vq5q).
...
Hinterhalte können von einer Gruppe und gegen eine Gruppe von Zielen durchgeführt werden. Dies folgt den üblichen Regeln für Verstohlenheit - der Charakter mit der niedrigsten Fertigkeitsstufe "Bewegen" <!-- TODO Hä? Warum nicht schleichen? Fehler im Original? --> würfelt für die Angreifer, während der Charakter mit der höchsten Fertigkeitsstufe "Auskundschaften" für die Ziele würfelt.
...
Jeder der folgenden Faktoren modifiziert deinen Wurf um -1.
...
Wenn sowohl du als auch ein Feind eine Überwachungsposition gegeneinander einnehmen und beide beschließen, gegeneinander zu feuern, dann bestimmt ein vergleichender Schießwurf, welcher Angriff zuerst ausgeführt wird. Dieser Wurf zählt nicht als Aktion für einen von euch.

**Überwachungsposition verlieren**: Du behältst deine Überwachungsposition, solange du nichts anderes tust, als in die gewählte Richtung zu schießen. Wenn du eine andere Aktion durchführst, ist die Überwachungsposition verloren. Sie geht auch sofort verloren, wenn einer der folgenden Fälle eintritt:

- Du wirst im Nahkampf angegriffen.
- Du erleidest Schaden jeglicher Art.

# **WAFFEN**

Die Verwendung einer Waffe verbessert die Effektivität im Kampf erheblich. Die folgende Tabelle beschreibt einige typische Waffen verschiedener Typen. Welche Waffen du genau in dein Spiel aufnimmst, hängt stark von der Spielkulisse ab. Die in den Waffentabellen verwendeten Eigenschaften werden im Folgenden erklärt.

**Griff** gibt an, ob man eine oder zwei Hände braucht, um die Waffe zu führen. Eine zweihändige Waffe kann nicht mit einem Schild kombiniert werden, und einige kritische Verletzungen verbieten die Verwendung von zweihändigen Waffen.

**Bonus** gibt an, wie viele Ausrüstungswürfel man würfeln kann, wenn man die Waffe benutzt. Beachte, dass der Ausrüstungsbonus reduziert werden kann, wenn du deinen Wurf strapazierst - der Bonus verringert sich um eins für jedes [Unheil](#wz393zv4wvg6), das du gewürfelt hast. Wenn der Ausrüstungsbonus auf Null reduziert wird, geht die Waffe kaputt und muss mit der Fertigkeit "Handwerk" repariert werden.

**Schaden** gibt an, wie hoch der Grundschaden ist, d.h. wie viele Punkte Schaden auf Stärke der Gegner erleidet, wenn der Angriff erfolgreich ist. Wenn du zusätzliche Erfolge würfelst, kannst du zusätzlichen Schaden anrichten.

**Reichweite** gibt die maximale Reichweitenkategorie an, in der die Waffe eingesetzt werden kann.

**Gewicht** gibt an, wie viele typische Gegenstände die Waffe in der Inventarliste zählt.

## **WAFFEN**

|**WAFFEN**|**GRIFF**|**BONUS**|**SCHADEN**|**REICHWEITE**|**GEWICHT**|
| :- | :-: | :-: | :-: | :-: | :-: |
|Unbewaffnet|-|-|1|Auf Armlänge|-|
|Knüppel|1H|+1|1|Auf Armlänge|1|
|Messer|1H|+1|2|Auf Armlänge
|Schläger|1H|+2|1|Auf Armlänge|1|
|Schwert|1H|+2|2|Auf Armlänge|1|
|Kampfaxt|2H|+2|3|Auf Armlänge|2|
|Speer|1H|+1|2|Kurz|1|
|Geworfener Stein|1H|-|1|Mittel|1/4|
|Schleuder|1H|+1|1|Mittel|1/2|
|Bogen|2H|+1|1|Lang|1|
|Pistole|1H|+2|2|Mittel|1/2|
|Gewehr|2H|+2|2|Lang|1|

> ### ***KRITISCHE BEWERTUNGEN*** <!-- TODO blöde übersetzung, nix besseres eingefallen -->
>
> *In einigen Year Zero Engine-Spielen haben Waffen auch Krit-Werte. Wenn du in einem einzigen Angriff Schaden in Höhe der Krit-Wertung oder darüber zufügst, fügst du dem Ziel sofort eine kritische Verletzung zu, auch wenn es durch den Schaden nicht gebrochen wird. Lesen Sie mehr über kritische Verletzungen [hier](#ae6oj9rgfcc).*

# **SCHADEN**

Year Zero Engine-Spiele können tödlich sein. Die Belohnungen für deinen SC mögen großartig sein, aber das Einzige, was du mit Sicherheit weißt, ist, dass du auf deinem Weg alle Arten von Schaden erleiden wirst. Schaden kann in vielen Formen auftreten und verringert einen Ihrer vier Attributwerte:

**Schaden an Stärke**: Blutende Wunden, gebrochene Knochen und Schmerzen. Dies ist die Standardschadensart. Wenn die Art des Schadens nicht angegeben ist, handelt es sich immer um Schaden an der Stärke.

**Schaden an Beweglichkeit**: Körperliche Ermüdung und Erschöpfung.

**Schaden für Verstand**: Furcht, Panik, Verwirrung, Fehleinschätzung. Lesen Sie mehr über Angst [hier](#s647jv9264xz).

**Schaden der Empathie**: Zynismus, Misstrauen, Gefühllosigkeit.

## **SCHADEN ERLEIDEN**

Du kannst auf viele Arten Schaden erleiden. Dies sind die drei häufigsten:

- **Durch Würfeln eines Unheil** (eine Eins) auf einem Basiswürfel, wenn Sie einen Wurf strapazierst. Wenn du strapazierst, erleidest du für jedes gewürfelte Unheil einen Punkt Schaden auf das verwendete Attribut.
- **Von Angriffen**. Immer, wenn dich jemand im Nahkampf oder mit einer Fernkampfwaffe erfolgreich angreift, erleidest du Schaden auf Stärke in Höhe des Schadenswerts der Waffe, plus Schaden für jeden zusätzlich gewürfelten Erfolg.

## **RÜSTUNG**

Indem du eine Rüstung trägst, kannst du deinen Körper vor Schaden an Stärke schützen. Rüstung bietet keinen Schutz vor anderen Arten von Schaden oder vor Schaden, den Sie sich selbst zufügen, wenn du einen Wurf strapazierst.

Die Wirkung einer Rüstung wird durch ihren Rüstungswert bestimmt. Wenn du durch einen physischen Angriff Schaden erleidest, wirfst du eine Anzahl von Rüstungswürfeln, die dem Rüstungswert entspricht. Jeder Erfolg, den du würfelst, vermindert den Schaden um eins. Dieser Wurf zählt nicht als Aktion und kann nicht strapaziert werden.

Wenn der Schaden die Rüstung durchdringt, wird der Rüstungswert verringert - jedes gewürfelte Unheil verringert den Rüstungswert um eins. Wenn die Rüstung den gesamten Schaden absorbiert hat, hat jedes gewürfelte Unheil keine Wirkung. Rüstungen können mit der Fertigkeit "Handwerk" repariert werden.

**Helme:** Du kannst immer nur eine Art von Rüstung tragen, aber du kannst Körperrüstungen mit einem Helm kombinieren. Addiere den Rüstungswert eines Helms, den du trägst, zum Wert deiner Körperrüstung, bevor du würfelst. Wenn die Rüstung beschädigt wird, kannst du wählen, ob es die Körperrüstung oder der Helm ist, der beschädigt wird.

Alle Helme haben außerdem einen zusätzlichen Effekt: Wenn du trotz des Rüstungswurfs eine körperliche kritische Verletzung #16, #64 oder #65 erleidest (siehe Tabelle [hier](#wn248olr4jib)), wirfst du eine Anzahl von Ausrüstungswürfeln, die dem Rüstungswert des Helms entspricht. Wenn Sie einen oder mehrere Erfolge würfeln, wird die kritische Verletzung stattdessen auf die #12 geändert. Ein solider Helm kann Ihr Leben retten!

## **DECKUNG**

Wenn Feinde auf dich schießen, kann es dir das Leben retten, wenn du dich in Deckung begibst - vorzugsweise in etwas Festes. Das Einnehmen von Deckung in der Zone, in der du dich befindest, zählt als eine schnelle Aktion. Deckung hat einen Rüstungswert und funktioniert genau wie eine Rüstung - allerdings nur gegen Fernkampfangriffe. Deckung kann genau wie Rüstung verschlechtert werden. Deckung kann mit Rüstung kombiniert werden - würfeln Sie zuerst für Deckung, dann für Rüstung.

## **DECKUNG**

|**BARRIERE**|**RÜSTUNGSWERT**|
| :- | :- |
|Möbel|3|
|Holztür|4|
|Baumstamm|5|
...
Wenn ein Attributwert Null erreicht, bist du gebrochen. Das bedeutet, dass du auf die eine oder andere Weise außer Gefecht gesetzt bist. Was genau es bedeutet, gebrochen zu sein, hängt davon ab, welches Attribut verbraucht wurde:

**Stärke**: Du wurdest bewusstlos geschlagen. Würfle für eine physische [kritische Verletzung](#ae6oj9rgfcc). Wenn du nicht tot bist, kannst du nur kriechen und durch den Schmerz murmeln. Du kannst keine anderen Aktionen ausführen und keine Fertigkeiten würfeln.

**Geschicklichkeit**: Du brichst vor Erschöpfung zusammen. Du kannst nur noch kriechen und keuchen. Du kannst keine anderen Aktionen ausführen und keine Fertigkeiten würfeln.

**Verstand:**: Du bist durch Angst oder Verwirrung gelähmt. Würfle für eine kritische Verletzung auf der [Psychotrauma-Tabelle](#kix.rdmwr3izc4jq). Wenn du bei Bewusstsein bleibst, kannst du an einen sicheren Ort rennen, aber du kannst keine anderen Aktionen ausführen und du kannst nicht für irgendwelche Fähigkeiten würfeln.

**Empathie:** Du brichst in Verzweiflung oder Selbstmitleid zusammen. Du musst entweder in einem gewalttätigen Ausbruch explodieren und alles um dich herum treten und zerbrechen, oder dich von allen um dich herum zurückziehen. In jedem Fall bist du unkommunikativ, bis du einen Punkt Empathie wiedererlangt hast.

## **MEHR SCHADEN**

Du kannst in keinem Attribut unter Null gehen, wenn du weiteren Schaden an Stärke oder Verstand erleidest, während du gebrochen bist, erleidest du eine weitere kritische Verletzung.

## **GNADENSTOSS**

Ein Gegner, der alle Stärke oder Beweglichkeit verloren hat, ist wehrlos. Wenn es sich um ein intelligentes Wesen (mit Verstand) handelt und du ihm einen Gnadenstoß versetzen und ihn auf der Stelle töten willst, musst du einen Empathiewurf *versagen* (würfle nur für das Attribut). Selbst wenn der Wurf misslingt, erleidest du einen Punkt Schaden an Empathie - kaltblütiges Töten ist nicht so einfach, wie du vielleicht denkst. Einige Talente ermöglichen es dir, wehrlose Feinde ohne diese negativen Auswirkungen zu töten.

# **ERHOLUNG**

Solange du nicht gebrochen bist, erholst du einen verlorenen Attributspunkt pro Runde (5-10 Minuten) Ruhe, vorausgesetzt, du leidest nicht an einem [Zustand](#ir1if07zqw1o), der die Erholung blockiert. Wenn du mehrere beschädigte Attribute hast, entscheidest du die Reihenfolge, in der sie geheilt werden. Die Anwendung der Fertigkeit "Heilen" auf dich hat keine Auswirkung, wenn du nicht "Gebrochen" bist.

## **WIEDERAUFSTEHEN**

Wenn du gebrochen bist, ist der schnellste Weg, dich zu erholen, wenn dich jemand anderes in derselben Zone durch einen erfolgreichen Heilungswurf behandelt. Du erhältst sofort eine Anzahl von Punkten im Attribut "Gebrochen", die der Anzahl der gewürfelten Erfolge entspricht. Weitere Heilungswürfe haben keine Wirkung, und dieselbe Person kann es nur einmal versuchen. Wenn dir innerhalb einer Runde niemand hilft, erholst du dich trotzdem und erhältst einen Punkt in der entsprechenden Attributswertung zurück. Nachdem du nicht mehr gebrochen bist, erhältst du die restlichen verlorenen Attributspunkte normal zurück (siehe oben). Kritische Verletzungen können dich aber auch noch beeinträchtigen, nachdem alle deine Attribute wiederhergestellt sind.

**Kritische Verletzungen:** Wenn deine Stärke gebrochen ist und du eine kritische Verletzung erlitten hast, besteht die Gefahr, dass du stirbst, wenn du nicht rechtzeitig behandelt wirst. Lesen Sie weiter unten mehr.

> ### ***GEBROCHENE NSCS***
> 
> *NSCs können auf die gleiche Weise gebrochen werden wie SCs. Ein NSC kann einen SC heilen und andersherum. Allerdings wird normalerweise nicht gewürfelt, wenn ein NSC einen anderen NSC heilt - stattdessen entscheidet die Spielleitung, was passiert. Die Spielleitung kann auch entscheiden, dass ein unbedeutender NSC, dessen Stärke gebrochen ist, einfach stirbt.*

# **KRITISCHE VERLETZUNGEN**

Gebrochen zu werden ist immer schlecht, aber wenn deine Stärke oder dein Verstand gebrochen ist, ist das besonders gefährlich - es kann Langzeiteffekte auslösen und dich sogar dein Leben kosten. Die Tabellen für kritischen Schaden finden Sie unten. Würfle W66 auf der Tabelle für die Art des Schadens, den du erlitten hast - körperlich (wenn deine Stärke gebrochen ist), oder geistig (wenn dein Verstand gebrochen ist).

## **TOD**

Wenn du eine kritische Verletzung erleidest, die als *tödlich* aufgeführt ist, musst du einen Todeswurf machen, wenn die angegebene Zeit abläuft. Ein Todeswurf ist ein Wurf für Ausdauer, unter Verwendung deiner vollen Stärkezahl, modifiziert durch die Zahl in der Spalte Tödlich. Es ist *nicht* erlaubt, den Wurf zu strapazieren. Wenn der Todeswurf misslingt, stirbst du. Wenn er gelingt, bleibst du am Leben, aber du musst einen weiteren Todeswurf machen, wenn die gleiche Zeitspanne vergangen ist.

**Gebrochen**: Wenn du sowohl gebrochen bist als auch eine tödliche kritische Verletzung (oder mehrere) erlitten hast, werden zwei separate Heilungswürfe benötigt: einer, um dich wieder auf die Beine zu bringen, und ein weiterer, um dein Leben zu retten. Diese beiden Würfe können in der von dir bevorzugten Reihenfolge durchgeführt werden.

**Sofortiger Tod:** Man beachte, dass es eine kleine Anzahl von kritischen Verletzungen gibt, die einen sofort töten. Wenn du eine dieser Verletzungen würfelst, war's das. Zeit, einen neuen Charakter zu erstellen.

## **HEILUNG**

Jede kritische Verletzung hat einen spezifischen Effekt, den du während der angegebenen Heilungszeit erleidest - gemessen in Tagen.

**Pflege**: Wenn es jemandem gelingt, dich während des Heilungsprozesses einer kritischen Verletzung zu heilen, wird die verbleibende Heilungszeit um die Hälfte reduziert. Ein früherer Wurf, um dein Leben zu retten, zählt dabei nicht mit - es ist ein neuer Wurf erforderlich, um die Heilungszeit zu reduzieren.

**Attributpunkte:** Man beachte, dass man alle verlorenen Attributpunkte wiedererlangen kann, aber trotzdem die Auswirkungen einer kritischen Verletzung erleidet.

## **UNTYPISCHE SCHÄDEN**

Für einige spezielle Arten von physischem Schaden - z. B. durch Feuer, Kälte, Verhungern, etc. - wird die Tabelle für kritischen Schaden nicht verwendet. Stattdessen werden die Auswirkungen des Gebrochen sein durch diese Schadensformen in dem entsprechenden Regelabschnitt unten beschrieben.

## **SCHADEN DURCH STRAPAZIEREN**

Es gibt einen Fall, in dem du beim Gebrochen sein keine kritische Verletzung riskierst: wenn du einen Wurf strapazierst, dass du dich selbst brichst. Dies ist sehr selten, kann aber passieren. Das bedeutet, dass du dich niemals selbst töten kannst, indem du einen Wurf strapazierst.

## **KRITISCHE VERLETZUNGEN - PHYSISCH**

|**W66**|**VERLETZTUNG**|**TÖDLICH**|**ZEITRAUM**|**EFFEKT WÄHREND DER HEILUNGSZEIT**|**HEILUNGSZEIT**|
| :- | :- | :-: | :-: | :- | :-: |
|11|Außer Atem|Nein|-| Keine.|-|
|12|Betäubt|Nein|-|Keine.|-|
|13|Lähmende Schmerzen|Nein|-|Keine.|-|
|14|Verstauchter Knöchel|Nein.|-|Bewegung -2 und kann nicht rennen, bis ein Heilungswurf gemacht wird.|-|
|15|Blut in den Augen|Nein|-|Auskundschaften und Schießen -2 bis Heilungswurf gemacht wird.|-|
|16|Gehirnerschütterung|Nein|-|Bewegen -2.|W6|
|21|Abgetrenntes Ohr|Nein|-|Auskundschaften -2.|W6|
|22|Gebrochene Zehen|Nein|-|Laufen wird zu einer langsamen Aktion.|W6|
|23|Gebrochene Hand|Nein|-|Kann die Hand nicht benutzen.|W6|
|24|Ausgeschlagene Zähne|Nein|-|Manipulieren -2.|W6|
|25|Aufgespießter Oberschenkel|Nein|-|Laufen wird zu einer langsamen Aktion.|2W6|
|26|Aufgeschlitzte Schulter|Nein|-|Kann den Arm nicht benutzen.|W6|
|31|Gebrochene Nase|Nein|-|Manipulieren und Späher -1.|W6|
|32|Treffer im Schritt|Nein|-|Ein Punkt Schaden bei jedem Wurf für Bewegen und Kampf.|W6|
|33|Gebrochene Rippen|Nein|-|Bewegen und Auskundschaften -2.|2W6|
|34|Ausgekochtes Auge|Nein|-|Schießen und Auskundschaften -2.|2W6|
|35|Kaputte Kniescheibe|Nein|-|Kann nicht laufen, nur kriechen -2.|2W6|
|36|Gebrochener Arm|Nein|-|Kann den Arm nicht benutzen.|2W6|
|41|Gebrochenes Bein|Nein|-|Kann nicht rennen, nur kriechen.|2W6|
|42|Zerquetschter Fuß|Nein|-|Kann nicht rennen, nur kriechen.|3W6|
|43|Zerquetschter Ellbogen|Nein|-|Kann den Arm nicht benutzen.|3W6|
|44|Lunge durchstochen|Ja|Tag|Ausdauer und Bewegung -2.|W6|
|45|Blutende Eingeweide|Ja|Schicht|Ein Punkt Schaden bei jedem Wurf für Bewegen und Kämpfen.|W6|
|46|Gerissene Eingeweide|Ja|Verschiebung|Krankheit mit Virulenz 6.|2W6|
|51|Gerissene Niere|Ja|Tag|Kann nicht laufen, nur kriechen, Bewegung -2.|2W6|
|52|Durchtrennte Armarterie|Ja -1|Zug|Kann Arm nicht benutzen.|2W6|
|53|Abgetrennte Beinarterie|Ja -1|Zug|Laufen wird eine langsame Aktion.|W6|
|54|Abgetrennter Arm|Ja -1|Tagesabschnitt|Kann Arm nicht benutzen.|W6|
|55|Abgetrenntes Bein|Ja -1|Tagesabschnitt|Kann nicht rennen, nur kriechen.|Dauerhaft|
|56|Gebrochene Wirbelsäule|Nein|-|Gelähmt vom Hals abwärts. Wenn du nicht rechtzeitig geheilt wird, ist der Effekt permanent.|3W6|
|61|Riss der Halsschlagader|Ja -1|Runde|Ausdauer -1.|2W6|
|62|Gerissene Aorta|Ja -2|Runde|Ausdauer -2.|3W6|
|63|Ausgeweidet|Ja|-|Sofortiger Tod.|-|
|64|Zertrümmerter Schädel|Ja|-|Deine Geschichte endet hier.|-|
|65|Durchbohrter Kopf|Ja|-|Sofortiger Tod.|-|
|66|Aufgespießtes Herz|Ja|-|Ihr Herz schlägt zum letzten Mal.|-|

## **CRITICAL INJURIES – MENTAL**

|**W66**|**TRAUMA**|**WIRKUNG WÄHREND DER HEILUNG**|**HEILUNGSZEIT**|
| :- | :- | :- | :-: |
|11-16|Zittern|Modifikation -1 auf alle Würfe für Geschicklichkeit.|W6|
|21|Graue Haare|Keine.|Permanent|
|22-24|Angstlich|Modifikation -1 auf alle Würfe für Verstand.|W6|
|25-31|Mürrisch|Modifikation -1 auf alle Würfe für Empathie.|W6|
|32-35|Alpträume|Machen einen Emotionsgespürwurf für jede Tagesabschnitt, den du im Schlaf verbringen. Scheitern bedeutet, dass der Schlaf nicht zählt.|W6|
|36-41|Nachtaktiv|Du kannst nur während des hellen Teils des Tages schlafen.|2W6|
|42-43|Phobisch|Du hast Angst vor etwas, das mit dem zu tun hat, was dich gebrochen hat. Die SL entscheidet, was es ist. Du erleidest einen Punkt Schaden auf Verstand jede Runde in kurzer Entfernung zum Objekt deiner Phobie.|2W6|
|44-45|Alkoholiker|Du musst jeden Tag Alkohol trinken, oder du erleidest einen Punkt Schaden auf Geschicklichkeit.|3W6|
|46-51|Klaustrophobisch|Jede Runde in einer engen Umgebung erleidst du einen Punkt Schaden auf Verstand.|2W6|
|52|Mythomanisch|Du kannst dich nicht davon abhalten, über alles zu lügen. Der Effekt sollte im Rollenspiel eingesetzt werden.|2W6|
|53-54|Paranoia|Du bist sich sicher, dass jemand es auf dich abgesehen hat. Der Effekt sollte im Rollenspiel dargestellt werden.|2W6|
...
|56|Halluzinationen| Mach bei jede Tagesabschnitt einen Emotionsgespürwurf. Wenn du versagst, erleidest du eine starke Halluzination. Die SL bestimmt die Details.|3W6|
|61-62|Veränderte Persönlichkeit|Deine Persönlichkeit wird auf eine fundamentale Weise verändert. Legen dich zusammen mit der SL fest, wie. Der Effekt sollte im Rollenspiel dargestellt werden.|Permanent|
|63|Amnesie|Du verlierst alle Erinnerungen und kannst dich nicht mehr erinnern, wer du oder die anderen SCs sind. Die Auswirkung sollte im Rollenspiel dargestellt werden.|W6|
|64-65|Katatonisch|Du starrst leer in die Vergessenheit und reagieren auf keinerlei Reize.|W6|
|66|Herzanfall|Dein Herz bleibt stehen und du stirbst vor lauter Schreck.|-|

# **ZUSTÄNDE**

In der Year Zero Engine gibt es vier *Zustände*, unter denen dein SC leiden kann: Verhungern, Verdursten, Erschöpfung und Einfrieren. Diese können Schaden verursachen und die Erholung blockieren. Markiere die Bedingungen in den entsprechenden Kontrollkästchen auf deinem Charakterbogen.

## **VERHUNGERN**

Du musst mindestens einmal pro Tag eine Ration Nahrung zu dir nehmen, was einen [Vorrat](#1p7qxzv7s00f) Wurf für Nahrung auslöst. Nach einem Tag ohne Nahrung wirst du hungrig. Dies hat mehrere Auswirkungen:

- Du kannst keine Stärke wiederherstellen. Du kannst andere Attribute wiederherstellen.
- Du erleidest einen Punkt Schaden an Stärke pro Woche. Wenn deine Stärke gebrochen ist, während du hungerst, stirbst du nach einer weiteren Woche ohne Nahrung.
- Sobald du gegessen hast, bist du nicht mehr am Verhungern und kannst deine Stärke normal wiederherstellen.

## **VERDURSTEN**

Du musst mindestens einmal pro Tag eine Ration Wasser trinken, was einen Versorgungswurf für Wasser auslöst. Nach einem Tag ohne Wasser bist du am verdurstet. Dies hat mehrere Auswirkungen:

- Du kannst keine Attribute wiederherstellen. Wenn du gebrochen bist, musst du Wasser trinken, um wieder aufstehen zu können.
- Du erleidest jeden Tag einen Punkt Schaden an Stärke und Geschicklichkeit. Wenn entweder deine Stärke oder deine Geschicklichkeit gebrochen sind, während du durstig bist, stirbst du nach einem weiteren Tag ohne Wasser.
- Sobald du trinkst, bist du nicht mehr durstig und kannst deine Attribute normal wiederherstellen.

## **MÜDE**

Du musst jeden Tag mindestens einen Tagesabschnitt lang schlafen. Nach einem Tag ohne Schlaf wirst du müde. Dies hat mehrere Auswirkungen:

- Du kannst deinen Verstand nicht wiederherstellen. Wenn dein Verstand gebrochen ist, während du müde bist, musst du mindestens einen Tagesabschnitt schlafen, um wieder auf die Beine zu kommen.
- Du erleidest jeden Tag einen Punkt Schaden an deinem Verstand. Wenn dieser Schaden deinen Verstand bricht, brichst du zusammen und schläfst für mindestens einen Tagesabschnitt. Du erleidest *keine* kritische geistige Verletzung.
- Sobald du mindestens eine Schicht lang geschlafen hast, bist du nicht mehr erschöpft und kannst deinen Verstand normal wiedererlangen.

## **UNTERKÜHLT**.

In einer Umgebung, in der es nicht genügend Kleidung oder Schutz gibt, wirst du zu unterkühlen. Das Unterkühlen hat mehrere Auswirkungen:

- Du kannst weder Stärke noch Verstand wiederherstellen. Wenn du gebrochen bist, während du frierst, musst du einen Todeswurf machen, wenn du das nächste Mal wegen der Kälte würfeln müsstest.
- Du musst in regelmäßigen Abständen Ausdauerwürfe machen. Je kälter es ist, desto häufiger musst du würfeln. Wenn es über dem Gefrierpunkt ist, reicht einmal pro Tag aus. Bei Temperaturen unter dem Gefrierpunkt würfelt man einmal pro Tagesabschnitt, und bei extremer Kälte muss man jede Runde würfeln. Wenn du versagst, erleidest du einen Punkt Schaden an Stärke und Verstand - da die Kälte in deinen Körper eindringt und das Blut langsamer zu deinem Gehirn fließt. Du kannst sogar halluzinieren, was dazu führt, dass du irrational handelst - Details sind der SL überlassen. Manche sagen, dass du, wenn du kurz vor dem Erfrieren bist, ein starkes brennendes Gefühl verspürst, das dich dazu bringen kann, dir die Kleidung vom Leib zu reißen.
- Nachdem du dich wieder aufgewärmt hast, und sei es nur an einem Lagerfeuer, bist du nicht mehr am Erfrieren und kannst Stärke und Verstand normal wiedererlangen.

# **VERBRENNUNGEN**

Ein Feuer wird in Intensität gemessen. Ein typisches Feuer hat die Intensität 8. Wenn du einem Feuer ausgesetzt bist, würfelst du eine Anzahl von Basiswürfeln, die der Intensität entspricht. Für jeden gewürfelten Erfolg erleiden Sie einen Punkt Schaden. Eine Rüstung kann dich schützen.

Wenn du Schaden nimmst, fängst du Feuer und brennst weiter und erleidest zu Beginn jeder neuen Runde einen weiteren Angriff. Die Intensität erhöht sich jede Runde um eins. Sobald ein Feuerangriff keinen Schaden mehr zufügt, erlischt das Feuer von selbst. Du oder ein Gefolgsperson in Angriffsreichweite kann das Feuer mit einem erfolgreichen Bewegenwurf (langsame Aktion) löschen.

Wenn du durch Feuerschaden gebrochen wirst oder Feuerschaden erleidest, wenn du bereits gebrochen bist, musst du jede Runde einen Todeswurf machen, bis du stirbst oder du durch einen Heilungswurf gerettet wirst.

# **EXPLOSIONEN**

Die Kraft einer Explosion wird in Sprengkraft gemessen. Für jede Person, die sich zum Zeitpunkt der Detonation in kurzer Reichweite der Explosion befindet, würfle eine Anzahl von Basiswürfeln, die der Stärke der Explosion entspricht. Für jeden gewürfelten Erfolg erleidet das Opfer einen Punkt Schaden. Der Wurf kann nicht strapaziert werden. Opfer, die sich auf Armlänge zur Detonation befanden, erleiden einen zusätzlichen Schadenspunkt.

**Effektradius**: Starke Sprengladungen mit einer Sprengkraft von 7 oder mehr können Menschen auch in mittlerer Entfernung Schaden zufügen. Die Sprengkraft wird dann um 6 reduziert. Wenn sich viele Personen in mittlerer Reichweite der Explosion befinden, kann die SL den Prozess vereinfachen, indem einmal gewürfelt wird und das Ergebnis auf alle Opfer angewendet wird.

# **FALLEN**

Ein Sturz auf eine harte Oberfläche fügt Ihnen automatisch einen Schadensbetrag zu, der der Fallhöhe (in Metern) geteilt durch 2 entspricht, wobei alle Bruchteile abgerundet werden. Bei einem kontrollierten Sprung würfelst du "Bewegen" - jeder gewürfelte Erfolg reduziert den verursachten Schaden um eins. Auch eine Rüstung kann dich vor Fallschaden schützen, allerdings nicht, wenn sie aus Metall besteht.

# **ERTRINKEN**.

Bei allen PCs wird vorausgesetzt, dass sie schwimmen können. Wenn du im Wasser landest, musst du jeden Zug einen Ausdauerwurf machen, um über Wasser zu bleiben. Wenn du eine Metallrüstung trägst, musst du jede Runde einen Wurf machen.

Wenn du untergehst, musst du jede Runde einen Ausdauerwurf machen, um deinen Atem anzuhalten. Wenn du versagst, beginnst du zu ertrinken und erleidest jede Runde einen Punkt Schaden an Stärke, bis dich jemand rettet. Wenn du beim Ertrinken gebrochen wirst, stirbst du nach einem Zug.

# **GIFT**

Gifte werden nach ihrer Potenz gemessen. Ein schwaches Gift hat die Potenz 3, ein starkes Gift hat die Potenz 6, und ein extrem starkes Gift kann die Potenz 9 oder sogar mehr haben. Wenn du auf irgendeine Weise Gift zu dir nimmst, würfelst du einen Gegenwurf gegen den GM - sie würfelt eine Anzahl von Basiswürfeln, die der Potenz entspricht, und du würfelst für "Ausdauer". Wenn das Gift gewinnt, erleiden Sie seine volle Wirkung. Wenn du den Wurf gewinnst, erleidest du nur die begrenzte Wirkung des Giftes.

## **TÖDLICHES GIFT**

**Volle Wirkung:** Du erleidest jede Runde einen Punkt Schaden an Stärke, bis du gebrochen bist. Deine kritische Verletzung zählt als untypisch. Wenn du rechtzeitig ein Gegengift trinkst, wird die Wirkung des Giftes aufgehalten.

**Begrenzte Wirkung:** Du erleidest einen Punkt Schaden an Stärke.

## **LÄHMENDES GIFT**

**Volle Wirkung:** Du nimmst jede Runde einen Punkt Schaden an der Geschicklichkeit, bis du gebrochen bist. Wenn du rechtzeitig ein Gegengift trinkst, wird die Wirkung des Giftes aufgehalten.

**Begrenzte Wirkung:** Sie erleiden einen Punkt Schaden an der Beweglichkeit.

## **SCHLAFENDES GIFT**

**Vollständige Wirkung:** Du erleidest jede Runde einen Punkt Schaden an deinem Verstand, bis du gebrochen bist, woraufhin du für einen Tagesabschnitt bewusstlos wirst. Du erleidest keine kritische Verletzung. Wenn du rechtzeitig ein Gegengift trinkst, wird die Wirkung des Giftes aufgehalten.

**Begrenzte Wirkung:** Du erleidest einen Punkt Schaden am Verstand.

## **HALLUZINOGENES GIFT**

**Volle Wirkung:** Du erleidest jede Runde einen Punkt Schaden an Empathie, bis du gebrochen bist. Wenn du rechtzeitig ein Gegengift trinkst, wird die Wirkung des Giftes aufgehalten.

**Begrenzte Wirkung:** Du erleidest 1 Punkt Schaden an Empathie.

# **KRANKHEIT**

Wenn du einer gefährlichen Ansteckung oder Infektion ausgesetzt bist, musst du einen vergleichender Wurf für "Ausdauer" gegen den Virulenzwert der Krankheit machen. Dies wird als Krankheitswurf bezeichnet. Eine typische Krankheit hat einen Virulenzwert von 3, aber es gibt auch Krankheiten mit viel höheren Werten. Wenn du den Wurf nicht schaffst, wirst du krank, was verschiedene Auswirkungen hat:

- Am Tag nach der Ansteckung bricht die Krankheit aus, und du erleidest jeweils einen Punkt Schaden an Stärke und Beweglichkeit.
- Du kannst deine Stärke oder Gewandtheit nicht wiederherstellen, während du krank bist.
- Mache einmal pro Tag einen weiteren Krankheitswurf. Jeder misslungene Wurf bedeutet, dass du einen weiteren Punkt Schaden an Stärke und Gewandtheit erleidest.
- Wenn deine Stärke während der Krankheit gebrochen ist, stirbst du nach einem weiteren Tag, wenn du dich bis dahin nicht erholt hast.
- Sobald du bei einem Krankheitswurf erfolgreich bist, bist du nicht mehr krank. Du hörst auf, Krankheitswürfe zu würfeln und erholst deine Attribute normal.

## **MEDIZINISCHE HILFE**

Wenn du während deiner Krankheit von jemandem betreut wirst, kann diese Person anstelle von dir deine Krankheitswürfe würfeln. Die Heilperson würfelt mit ihrer Fertigkeit "Heilen" gegen die Virulenz der Krankheit.

# **ANGST**

Furchterregende Erlebnisse, sei es durch phantastische Kreaturen oder profane Schrecken, verursachen sogenannte Furchtattacken. Ein Furchtangriff wird mit einer Anzahl von Basiswürfeln gewürfelt. Jeder gewürfelte Erfolg verursacht einen Punkt Schaden an Verstand. Alle Furchtangriffe haben eine kurze Reichweite, sofern nicht anders angegeben. Einige Furchtattacken zielen auf ein einzelnes Opfer, während andere jeden in Reichweite betreffen.

# **DUNKELHEIT**

Wenn du dich in völliger Dunkelheit befindest und keine Nachtsicht hast, hast du keine andere Wahl, als dich vorwärts/umher zu tasten. Um in völliger Dunkelheit zu laufen, ist ein erfolgreicher Bewegungswurf erforderlich, und du erleidest im Allgemeinen einen Punkt Schaden, wenn du diesen Wurf nicht schaffst.

Du kannst auf Armlänge Gegner in der Dunkelheit normal angreifen, aber du musst zuerst erfolgreich auskundschaften, um sie anvisieren zu können. Diese Aktion nimmt im Kampf keine Zeit in Anspruch - du kannst noch in derselben Runde auskundschaften und dann direkt angreifen.

Du kannst in völliger Dunkelheit nicht auf Ziele in mittlerer Reichweite oder mehr schießen. Du kannst auf Gegner auf Armlänge oder Kurze Distanz schießen, aber nur, wenn du zuerst einen Auskundschaftenwurf machst. Alle Angriffe in der Dunkelheit werden um -2 modifiziert.

# **REITTIERE**

Ein Pferd oder ein anderes Reittier kann ein nützlicher Vorteil sein. Das Tier kann (#1au9acnez9nl) Ausrüstung für dich tragen, und du kannst den Vorteil nutzen, während des Kampfes im Sattel zu sitzen.

**Bewegungsfähigkeit**: Mit Reittieren kannst du dich schneller über das Schlachtfeld bewegen, als wenn du zu Fuß unterwegs bist. Jedes Tier hat eine Bewegungsrate. Diese bestimmt, wie viele Zonen sich das Tier mit einer schnellen Aktion bewegen kann. Humanoide haben Bewegungsrate 1 und die meisten Reittiere haben Bewegungsrate 2.

Reittiere können sich generell nicht in beengte Zonen bewegen. In überfüllten Zonen zählt ihre Bewegungsrate als 1.

**Bewegen:** Wenn du auf einem Pferd sitzt und einen Bewegungswurf machst, verwende die Geschicklichkeit des Tieres anstelle deiner eigenen.

**Nahkampf:** Du kannst vom Pferd aus kämpfen, aber nur mit Einhandwaffen. Gegner, die dich angreifen, müssen sich entscheiden, ob sie dich oder das Pferd angreifen. Angriffe gegen einen berittenen Reiter erleiden einen Malus von -1.

**Fernkampf**: Alle Fernkampfangriffe vom Pferd aus erleiden eine -2 Modifikation. Gegner, die auf dich schießen, müssen sich entscheiden, ob sie dich oder das Pferd angreifen.

**Schaden:**: Dein Tier kann, genau wie du, Schaden erleiden, durch Angriffe oder durch strapazierte Würfe, wenn du die Attributspunkte des Tieres verwendest. Tiere erholen sich von Schaden genauso wie Spielcharaktere. Ein Tier, dessen Stärke auf Null reduziert wurde, erleidet keine kritische Verletzung, sondern gilt als verendet. Tiere haben im Allgemeinen weder Verstand noch Empathie.
...
Year Zero Engine German Translation Copyright 2021, Uhrwerk Verlag; translated by David Steinkopff (zeitiger)
